...
import com.suite.loaders.NpcDefinition;
...
public class NpcGUI extends JFrame {
	...
	private void itemListMouseReleased(MouseEvent e) {
		NpcDefinition npc = new NpcDefinition(SuiteUI.cache(),
				list1.getSelectedIndex());
		if (npc.name != "null") {
			label3.setText(npc.name);
		} else {
			label3.setText("");
		}
	}

	private void npcPackMouseReleased(MouseEvent e) {
		NpcDefinition.npcPack(SuiteUI.cache());
	...
	private void initComponents() {
		...
		button1.setText("Pack NPC");
		button1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseReleased(MouseEvent e) {
				npcPackMouseReleased(e);
			}
		});
